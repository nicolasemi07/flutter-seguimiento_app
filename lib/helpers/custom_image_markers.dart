...
Future<BitmapDescriptor> getAssetImageMarker() async {
  return await BitmapDescriptor.fromAssetImage(ImageConfiguration(devicePixelRatio: 2.5), 'assets/custom-pin.png');
}
...
Future<BitmapDescriptor> getNetworkImageMarker() async {
  ...
  // Opcional para cambiar la resolución de la imagen (hacerla más pequeña)
