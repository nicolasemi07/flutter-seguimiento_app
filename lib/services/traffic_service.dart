...
class TrafficService {
  ...
  final _apiKey = 'pk.eyJ1Ijoibmljb2xhc2VtaSIsImEiOiJja2xtamNjb28wOXNpMnBuem0zYnJpYTJrIn0.79wJsVOBmp7kTwHTHHEDkw';
  ...
  Future<DrivingResponse> getCoordsInicioYDestino(LatLng inicio, LatLng destino) async {
    ...
    return DrivingResponse.fromJson(resp.data);
  }
  ...
  Future<ReverseQueryResponse> getCoordenadasInfo(LatLng destinoCoords) async {
    ...
    return reverseQueryResponseFromJson(resp.data);
  }
